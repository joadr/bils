...
ExecutiveRole.allow('collections.news.remove', true); // Allows the role to remove documents
...
ExecutiveRole.allow('collections.news.showRemove', true); // Shows the delete button on the update view
