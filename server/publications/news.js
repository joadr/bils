...
Meteor.publishComposite('news.search', function(search, limit) {
  ...
  return {
    find: function() {
      return News.find(filter, { limit: limit, fields: { title: 1, groupsIds: 1, brandsIds: 1, date: 1, categorizedBy: 1, prevAprove: 1,hidden: 1, media: 1, mediumId: 1 }, sort: { date: -1 } });
    },
    children: [{
